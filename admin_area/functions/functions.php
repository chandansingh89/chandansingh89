...
";
	   ...
	   global $db;
				   ...
				   <div class='text'>
				   <h3><a herf='details.php?pro_id=$pro_id'>$pro_title</a></h3>
				   ...
				   $cat_id=$_GET['cat_id'];
				   $get_cat="select * from catogries where cat_id='$cat_id'";
			...
			if($count_order>0){
			 ...
			 <h2>You have $count_order pending order</h2>
			 <h3>Please see your order details by clicking this<a href='my_account.php?my_order'>LINK</a>
			 <br> or you can<a href='pay_offline.php?pay_offline'>Pay Offline</a></h3>
			...
			<h3> you can see your order history by clicking this link<a href='my_account.php?my_order'></a></h3>
			</div>
