		       ...
		       <div class="panel-body">
			      <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
					 ...
					 <div class="form-group">
						...
						<input type="file" name="product_img1" class="form-control" required="" value="<?php echo $row_edit['product_img1'];?>" >
					 </div>
					 
					 <div class="form-group">
					    <label class="col-md-3 control-label">Product Image 2</label>
						<input type="file" name="product_img2" class="form-control" required="" value="<?php echo $row_edit['product_img2'];?>" >
					 </div>
					 
					 <div class="form-group">
					    <label class="col-md-3 control-label">Product Image 3</label>
						<input type="file" name="product_img3" class="form-control" required="" value="<?php echo $row_edit['product_img3'];?>" >
					 </div>
					 
					 <div class="form-group">
					    <label class="col-md-3 control-label">Product Price</label>
						<input type="text" name="product_price" class="form-control" required="" value="<?php echo $row_edit['product_price'];?>" >
					 </div>
					 
					 <div class="form-group">
					    <label class="col-md-3 control-label">Product keyword</label>
						<input type="text" name="product_keywords" class="form-control" required="" value="<?php echo $row_edit['product_keyword'];?>" >
					 </div>
...
echo "$run_product";
 ...
 echo "<script>window.open('edit_prod.php')</script>";
 }
