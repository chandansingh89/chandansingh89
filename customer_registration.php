		    ...
		    <div class="col-md-9">
			  <div class="box">
			    <div class="box-header">
				  <center><h2>Customer Registration</h2><p class="text-muted">Feel free to feed all queries required</p></center>	
			  ...
			  <form action="customer_registration.php" method="post" enctype="multipart/form-data">
				 ...
				 <div class="form-group">
				   ...
				   <input type="password" name="c_cpassword" required="" class="form-control">
				 </div>
...
$insert_customer="insert into customer(customer_name,customer_email,customer_pass,customer_country,customer_city,customer_contact,customer_address,customer_image,customer_ip) values ('$c_name','$c_email','$c_password','$c_country','$c_city','$c_contact','$c_address','$c_image','$c_ip')";
...
echo "<script> 
window.open('customer/checkout.php','_self')
</script>";
